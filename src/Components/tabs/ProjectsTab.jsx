const projects = [
  {
    ...
    title: 'StudyForgeAI',
    description: 'AI-powered educational platform that generates comprehensive study guides from PDFs, web articles, YouTube videos, and raw text inputs using Google Gemini 2.5 Flash Lite.',
  ...
  },
  {
    ...
    description: 'Full-stack F1 Fantasy League platform with real-time leaderboards, team management, and secure authentication using the MERN stack and TypeScript.',
    github: 'https://github.com/YuvamKumarSWE/F1FantasyLeague',
    deployed: 'https://ykf1-fantasy.vercel.app/',
    deployLabel: 'Live Demo',
    technologies: ['TypeScript', 'Node.js', 'React', 'MongoDB', 'Express'],
    status: 'Live',
  ...
  },
  {
    ...
    title: 'HireSignal',
    description: 'AI-powered interview preparation platform using Google Gemini and ElevenLabs for realistic voice/text interviews with real-time evaluation and feedback.',
